...
$curr_code=  validate_input($_POST['curr_code']);
$curr_desc=  validate_input($_POST['curr_desc']);
$curr_usd=  validate_input($_POST['curr_usd']);
$curr_usdx=  validate_input($_POST['curr_usdx']);
$usd_php=  validate_input($_POST['usd_php']);
$effect_date=  validate_input($_POST['effect_date']);
$effect_date_to=  validate_input($_POST['effect_date_to']);
$curr_apply=  validate_input($_POST['curr_apply']);
$add_edit=  validate_input($_POST['add_edit']);
$convtable_ctrlno=  validate_input($_GET['convtable_ctrlno']);
?>