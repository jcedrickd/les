...
<body>		
<div id="wrapper">
<b class="module">HBL Stock Entry</b>
<form method="post" id="form">
	<input type="hidden" value="73" name="module_no" id="module_no" />
<div class="form-inline col-xs-12 inline_elements">
	<div class="form-group">
	<input type="submit" class="btn btn-danger css_button btn-xs" name="NewHBL" onclick="" value="New" />
	</div><!--div class="form-group"-->
	<div class="form-group">
	<input type="submit" class="btn btn-danger css_button btn-xs" name="SaveAsHBL" onclick="" value="Save As" />
	</div><!--div class="form-group"-->
...
<tbody>
<?php
	//HBL STOCK ENTRY QUERY
	$sql = "SELECT * FROM hbl_stac ORDER BY stock_no";
...
<tr>
	...
	<td><?php echo $row['hbl_start'];?></td>
	<td><?php echo $row['hbl_count'];?></td>
