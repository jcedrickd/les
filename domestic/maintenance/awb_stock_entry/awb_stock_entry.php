...
<body>		
<div id="wrapper">
<b class="module">AWB Stock Entry</b>
...
<tbody>
	<?php
	//AWB STOCK ENTRY QUERY
	$sql = "SELECT * FROM awb_stac ORDER BY stock_no";
...
<tr>
	...
	<td><?php echo $row['air_code'];?></td>
	<td><?php echo $row['awb_start_from'];?></td>
	<td><?php echo $row['awb_start_to'];?></td>
	<td><?php echo $row['awb_count'];?></td>
