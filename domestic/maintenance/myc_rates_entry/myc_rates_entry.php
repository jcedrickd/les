...
<body>		
<div id="wrapper">
<b class="module">MYC Rates Entry</b>
<form method="post" id="form">
	<input type="hidden" value="73" name="module_no" id="module_no" />
<div class="form-inline col-xs-12 inline_elements">
	<div class="form-group">
	<input type="button" class="btn btn-danger css_button btn-xs" name="Add" value="Add" onClick="">
...
<tbody>
	<?php
	$sql = "SELECT * FROM myc_rate ORDER BY ctrlno";
...
<tr>
	...
	<td><?php echo $row['al_code'];?></td>
	<td><?php echo $row['area'];?></td>
	<td><?php echo $row['myc_rate'];?></td>
	<td><input type="text" class="input datepicker" name="dateeffect" value="<?php echo date("m/d/Y",strtotime($row['effect_date']));?>"/></td>
	<td><input type="text" class="input datepicker" name="dateexpire" value="<?php echo date("m/d/Y",strtotime($row['expiry_date']));?>"/></td>
	<td><?php echo $row['type_by'];?></td>
	<td><input type="text" class="input datepicker" name="datetime" value="<?php echo date("m/d/Y",strtotime($row['type_datetime']));?>"/></td>
