...
?>
	...
	window.open("http://<?php echo $_SERVER['SERVER_NAME'];?>/les/includes/lookup/jo/cust_list.php?id_name="+id_name,"_blank","height=700,width=900, status=yes,toolbar=no,menubar=no,location=no"); 
...
<div><label class="field">CHG:</label> <input type="text" name="service_code" value="<?php echo @$service_code; ?>" class="input" id="service_code" maxlength="7" onFocus="show_Service_Description(this.value);" onKeyUp="show_Service(this.value,'OS');" /> <input type="text" name="service_description" value="<?php echo @$service_description; ?>" class="input second_input bigtxt" id="service_description" readonly="readonly" /> <input type="button" class="btn btn-danger css_button btn-xs" value="Select" onClick="open_service_code_list('service_code',chg_grp.value,'OS');" /></div>
<div><label class="field">GRP:</label> <input type="text" name="chg_grp" value="<?php echo @$chg_grp; ?>" class="input" id="chg_grp" maxlength="7" onFocus="showChg_Grp(this.value);" onKeyUp="showChg_Grp(this.value);clear_service(this.value);" /> <input type="text" name="chg_grp_desc" value="<?php echo @$chg_grp_desc; ?>" class="input second_input bigtxt" id="chg_grp_desc" readonly="readonly" /> <input type="button" class="btn btn-danger css_button btn-xs" value="Select" onClick="open_chg_grp_list('chg_grp');" /></div>
